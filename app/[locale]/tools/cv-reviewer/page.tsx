...
import CVReviewer from "@/components/tools/CVReviewer";
...
export async function generateMetadata({ params }: Props) {
  ...
  return { title: t("cvReviewer") };
}

async function CVReviewerPage({ params }: Props) {
  const { locale } = await params;
...
export default withPremium(CVReviewerPage);
